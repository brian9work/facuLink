...
-- -----------------------------------------------------
INSERT INTO `cat_line_of_transport` (`id`, `name`, `completeName`, `imagen`) VALUES
...
-- Table `cat_faculty`
-- -----------------------------------------------------
INSERT INTO `cat_faculty` (`id`, `acronym`, `name`, `latitude`, `longitude`, `isActive`) VALUES
...
INSERT INTO `cat_degree` (`idFaculty`, `name`, `isActive`) VALUES
